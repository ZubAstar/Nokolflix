    ...
    <nav class="navbar navbar-expand-lg bg-dark border-bottom border-body" data-bs-theme="dark">
     ...
     <div class="body-sign">
        <div class="sign-in-container">
            <h3>For Premium Subscription Send Money TK.500 to <br> 0123456789 <br> via bKash, Nogod or Rocket With Your Email as Reference. Then Proceed for Sign In After 30 Minutes.</h3>
            <p>Done the payment? <a href="signIn.php">SignIn</a></p>
          </div>
        </div>
    <!--Navbar end-->
    <div class="container-fluid">
